...
def redraw_window(players, balloons, booms, current_id, sprites, water_power, item_map):
    screen.fill(white)
    #print(balloons)
...
while SB == 0:
    if room == 0: # 참가 or 방 생성 화면
        ...
        redraw_window(players, balloons, booms, current_id, sprites, water_power, item_map)
