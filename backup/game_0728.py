...
bubble_img.append(pygame.image.load('asset/bubble/18.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/19.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/20.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/21.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/22.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/23.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/24.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/25.png').convert_alpha())
bubble_img.append(pygame.image.load('asset/bubble/26.png').convert_alpha())
for i in range(0, 27):
